...
# change actual loss to label_smooth cross entropy only
...
class LabelSmoothedCrossEntropyCriterionWithContrastive(
    ...
    def forward(self, model, sample, reduce=True):
        ...
        return all_loss, sample_size, logging_output #sample_size, (this arg was returned in the middle of the tuple)
